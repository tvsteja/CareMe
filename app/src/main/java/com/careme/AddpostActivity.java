...
public class AddpostActivity extends AppCompatActivity {
    ...
    private EditText hl_et, add_et, hr_et, date_et, time_et, etExperience, desc_et, phone_et;
    String hl, add, hr, time, date, des, phone, type;
    ProgressBar pb;
    private ImageView ivProfilePic, iv1,iv2;
    ...
    String Database_Path = "userpost";
    RadioButton r1, r2, r3, r4;
    private String uid;
    private int mYear, mMonth, mDay, mHour, mMinute;
    private DecimalFormat formatter = new DecimalFormat("00");
    private String from = "", headLine = "", phoneNumber = "", address = "", hrate = "", pickDate = "", pickTime = "", exp = "", jobDesc = "", postType = "", pid = "", img = "";
    private Intent intent;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.addpost_activity_caregiver);
        ...
        if(intent.hasExtra("From")){
            ...
            exp              = intent.getExtras().getString("exp");
        ...
        if(postType.equalsIgnoreCase(r1.getText().toString())){
            r1.setChecked(true);
            r2.setChecked(false);
            r3.setChecked(false);
            r4.setChecked(false);
        }
        else if(postType.equalsIgnoreCase(r2.getText().toString())){
            r2.setChecked(true);
            r1.setChecked(false);
            r3.setChecked(false);
            r4.setChecked(false);
        }
        else if(postType.equalsIgnoreCase(r3.getText().toString())){
            r3.setChecked(true);
            r2.setChecked(false);
            r1.setChecked(false);
            r4.setChecked(false);
        }
        else if(postType.equalsIgnoreCase(r4.getText().toString())){
            r2.setChecked(false);
            r1.setChecked(false);
            r3.setChecked(false);
            r4.setChecked(true);
        ...
        if(!img.equalsIgnoreCase("")){
            Picasso.get().load(img).into(ivProfilePic);
        }
        ...
        iv2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(AddpostActivity.this,
        ...
        ivProfilePic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AddpostActivity.this, ImageSelectActivity.class);
    ...
    private void add(View view) {
        ...
        exp = etExperience.getText().toString().trim();
    ...
    private void addNewPost(final String postBy, final String email){
        if (filePath.isEmpty()) {
            ...
            PostItem postItem = new PostItem(PreferenceManager.GetUID(), hl, add, hr, date, time, exp, des,
                    staticimage, type, phone, PreferenceManager.GetUID() + ImageUploadId, postBy, email, "");
            ...
            storageReference2nd.putFile(FilePathUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            PostItem postItem = new PostItem(PreferenceManager.GetUID(), hl, add, hr, date, time, exp, des, url.toString(), type, phone, PreferenceManager.GetUID() + ImageUploadId, postBy, email, "");
                            rootRef.child(ImageUploadId).setValue(postItem);
                            pb.setVisibility(View.GONE);
                            Toast.makeText(AddpostActivity.this, "Post Added Successfully!!!", Toast.LENGTH_SHORT).show();
                            finish();
